...
describe('Multiplication tests', function() {
	...
	it('Checks if multiplication of multiple integers and floats is correct', () => {
		...
		expect(intExpression).to.equal(4749412.5);
	});
});